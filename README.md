...
| | count |
| --- | ---: |
| Skills in this repository | **88** |
| substantively modified by us, each with a fix log | 63 |
| unmodified apart from a declared `license: MIT` | 25 |
| **fix pass still needed** (first audit only, whatever the score) | **25** |
