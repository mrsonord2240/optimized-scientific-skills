...
| | count |
| --- | ---: |
| Skills in this repository | **125** |
| substantively modified by us, each with a fix log | 105 |
| unmodified apart from a declared `license: MIT` | 20 |
| **fix pass still needed** (first audit only, whatever the score) | **20** |
