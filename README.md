...
| | count |
| --- | ---: |
| Skills in this repository | **119** |
| substantively modified by us, each with a fix log | 95 |
| unmodified apart from a declared `license: MIT` | 24 |
| **fix pass still needed** (first audit only, whatever the score) | **24** |
